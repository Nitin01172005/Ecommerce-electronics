            ...
            <ul className="flex justify-between items-center gap-4">
              {
                MenuLinks.map((data, index) => (
                  <li key={index} className="text-gray-500 font-semibold hover:text-black">
                    <a href={data.link} className="inline-block px-4 duration-200 dark:hover:text-white">{data.name}</a>
                  </li>
                ))
              }
