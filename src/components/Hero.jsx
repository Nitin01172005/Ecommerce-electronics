              ...
              <div key={data.id}>
                <div className='grid grid-cols-1 sm:grid-cols-2 items-center'>
                  ...
                  <div className='flex flex-col gap-5'>
                    <h1 data-aos="fade-up" className='text-2xl font-bold'>{data.subtitle}</h1>
                    <h1 data-aos="fade-up" className='text-5xl sm:text-6xl lg:text-7xl font-bold'>{data.title} </h1>
                    <h1 data-aos="fade-up-left" className='text-5xl sm:text-[80px] md:text-[100px] xl:text-[150px] font-bold text-gray-100 uppercase'>{data.title2}</h1>
                    <div>
                      <button className='bg-primary px-8 py-2 hover:scale-105 duration-300 rounded-full z-10 relative text-white'>Shop by category</button>
                    </div>
                  </div>
                  <img src={data.img} 
